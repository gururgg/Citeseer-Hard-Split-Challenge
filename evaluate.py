...
pred_challenge = torch.tensor(submission['pred_challenge'].values, dtype=torch.int64)
pred_original = torch.tensor(submission['pred_original'].values, dtype=torch.int64)

# -----------------------------
# Extract predictions for masks
# -----------------------------
pred_challenge_masked = pred_challenge[test_mask_challenge]
pred_original_masked  = pred_original[test_mask]
...
# Compute accuracy
# -----------------------------
acc_challenge = accuracy_score(y_challenge.numpy(), pred_challenge_masked.numpy())
acc_casual    = accuracy_score(y_original.numpy(), pred_original_masked.numpy())
